...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, AIN1_Pin|BIN2_Pin|AIN2_Pin|BIN1_Pin
                          |DIN2_Pin|DIN1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : AIN1_Pin BIN2_Pin AIN2_Pin BIN1_Pin
                           DIN2_Pin DIN1_Pin */
  GPIO_InitStruct.Pin = AIN1_Pin|BIN2_Pin|AIN2_Pin|BIN1_Pin
                          |DIN2_Pin|DIN1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
