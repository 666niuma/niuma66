...
void MX_FREERTOS_Init(void) {
  ...
  /* creation of Screen */
  ScreenHandle = osThreadNew(Task_screen, NULL, &Screen_attributes);
...
__weak void Task_screen(void *argument)
{
...
/* USER CODE BEGIN Header_Task_wireless */
/**
* @brief Function implementing the Wireless thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Task_wireless */
__weak void Task_wireless(void *argument)
{
  /* USER CODE BEGIN Task_wireless */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
